...
int main(int argc, char** argv){
	...
	*/
    ...
    for(int n = 0; n < size; ++n){
        KMeansBenckmark(DATABASE, 2+n, time_arr, sd_time_arr, iters_arr, sd_iters_arr, errors_arr, sd_errors_arr, n);
    }
	std::cout << "\ncluster_size = [";
	for(int n = 0; n < size; ++n){
		std::cout << n+2 << ", ";
